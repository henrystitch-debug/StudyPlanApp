...
function useTheme() {
  // Server and the client's first render both start from the same fixed
  // value ("dark") — this is required for hydration to match. The real
  // stored/preferred theme is only read inside useEffect, which runs
  // strictly after hydration completes, so it can safely differ from
  // what the server sent without causing a mismatch.
