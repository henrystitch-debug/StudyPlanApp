...
export async function GET(request: Request) {
    ...
    // z.B. /api/calendar/calendarAllEvents?userId=123
    ...
    // GEÄNDERT: "await" ergänzt, da getAllEventsByUserId eine async-Funktion ist
    ...
    const dbResponse = await getAllEventsByUserId(userId);
